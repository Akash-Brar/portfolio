...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await emailjs.send("service_lps4zmb", "template_wn3d0wg", {from_name: formData.name, to_name: "Akash", from_email: formData.email, to_email: "akashbrar467@gmail.com", message: formData.message}, "vBaijwxwSRUkvbd_u");
            setIsLoading(false);

    ...
    <section className="c-space section-spacing">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
            ...
            <div className="flex items-end grid-default-color grid-1">
                ...
                <div className="z-1">
                    <p className="headtext">Hi, I'm Akash Brar</p>
                    <p className="subtext">A passionate developer with a deep curiosity for building everything from interactive web apps to analytical and systems level software.</p>
                </div>
            ...
            <div className="grid-default-color grid-2">
                <div ref={grid2Container} className="flex items-center justify-center w-full h-full">
                    <p className="flex items-end text-5xl text-gray-500">THE CRAFT OF CODE</p>
                    <Card style={{ rotate: "75deg", top:"30%", left: "20%"}} text="API Design" containerRef={grid2Container}/>
                    <Card style={{ rotate: "-30deg", top:"60%", left: "45%"}} text="Readability" containerRef={grid2Container}/>
                    <Card style={{ rotate: "50deg", bottom:"30%", left: "70%"}} text="Design Patterns" containerRef={grid2Container}/>
                    <Card style={{ rotate: "-45deg", top:"55%", left: "0%"}} text="Design Principles" containerRef={grid2Container}/>
                    <Card style={{ rotate: "20deg", top:"10%", left: "38%"}} text="Maintainability" containerRef={grid2Container}/>
            ...
            <div className="grid-black-color grid-3">
                <div className="z-10 w-[50%]">
                    ...
                    <p className="subtext">I'm based in Edmonton, Alberta, Canada, and open to remote work worldwide</p>
                </div>
